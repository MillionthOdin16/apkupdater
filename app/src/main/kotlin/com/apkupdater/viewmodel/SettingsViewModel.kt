...
class SettingsViewModel(
	...
	fun getApkMirrorAutomaticDownloadsEnabled() = prefs.apkMirrorAutomaticDownloadsEnabled.get()
	fun setApkMirrorAutomaticDownloadsEnabled(b: Boolean) = prefs.apkMirrorAutomaticDownloadsEnabled.put(b)
	fun getApkMirrorDownloadOnWifiOnly() = prefs.apkMirrorDownloadOnWifiOnly.get()
	fun setApkMirrorDownloadOnWifiOnly(b: Boolean) = prefs.apkMirrorDownloadOnWifiOnly.put(b)
